...
class AudioProcessor(object):
  ...
  def get_data(self, how_many, offset, flags, background_frequency,
    ...
    if how_many == -1:
      ...
      if flags.pick_deterministically and is_training:
    ...
    desired_samples = flags.desired_samples
    use_background = self.background_data and is_training
    pick_deterministically = (not is_training) or flags.pick_deterministically
    ...
    for i in xrange(offset, offset + sample_count):
      ...
      resample = 1.0
      if is_training and resample_offset != 0.0:
      ...
      if sample['label'] == SILENCE_LABEL:
        ...
        if is_training and volume_augmentation_offset != 0.0:
